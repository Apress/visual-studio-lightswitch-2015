...
(function (lightSwitchApplication) {
    ...
    msls._addEntryPoints(lightSwitchApplication.AddEditIssue, {
        ...
        /// <field>
        /// Called after the screenHeading content item has been rendered.
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
        screenHeading_postRender: [$element, function () { return new lightSwitchApplication.AddEditIssue().findContentItem("screenHeading"); }],
        /// <field>
        /// Called after the columns content item has been rendered.
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>

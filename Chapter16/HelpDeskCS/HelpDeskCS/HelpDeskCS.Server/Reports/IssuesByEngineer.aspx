<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssuesByEngineer.aspx.cs" Inherits="LightSwitchApplication.Reports.IssuesByEngineer" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView runat="server" ID="IssuesGrid2" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="IssuesGrid2_RowDataBound">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>

...
(function (lightSwitchApplication) {
    ...
    function Department(entitySet) {
        ...
        /// </field>
        /// <field name="FloorArea" type="Number">
        /// Gets or sets the floorArea for this department.
        /// </field>
    ...
    msls._addToNamespace("msls.application", {
        ...
        ApplicationData: $defineDataService(ApplicationData, lightSwitchApplication.rootUri + "/ApplicationData.svc", [
            ...
            {
                name: "EngineerPhoneticSearch", value: function (Name) {
                    return new $DataServiceQuery({ _entitySet: this.Engineers },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/EngineerPhoneticSearch()",
                        {
            ...
            {
                name: "EngineersWithIssues", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.Engineers },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/EngineersWithIssues()",
                        {
                        });
                }
            },
            {
                name: "EngineersWithNoIssues", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.Engineers },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/EngineersWithNoIssues()",
                        {
                        });
                }
            },
            ...
            {
                name: "IssuesMatchAll", value: function (criteria) {
                    return new $DataServiceQuery({ _entitySet: this.Issues },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/IssuesMatchAll()",
                        {
                            criteria: $toODataString(criteria, "String?")
                        });
                }
            },
            {
                name: "IssuesMatchSome", value: function (criteria) {
                    return new $DataServiceQuery({ _entitySet: this.Issues },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/IssuesMatchSome()",
                        {
                            criteria: $toODataString(criteria, "String?")
                        });
                }
            ...
            {
                name: "IssuesSearch", value: function (ProblemDescription) {
                    return new $DataServiceQuery({ _entitySet: this.Issues },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/IssuesSearch()",
                        {

...
(function (lightSwitchApplication) {
    ...
    function Engineer(entitySet) {
        ...
        /// </field>
        /// <field name="ClosedIssues" type="msls.EntityCollection" elementType="msls.application.Issue">
        /// Gets the closedIssues for this engineer.
        /// </field>
        /// <field name="CreatedBy" type="String">
    ...
    function Issue(entitySet) {
        ...
        /// </field>
        /// <field name="IssueStatusCollection" type="msls.application.IssueStatus">
        /// Gets or sets the issueStatusCollection for this issue.
        /// </field>
        ...
        /// </field>
        /// <field name="Engineer" type="msls.application.Engineer">
        /// Gets or sets the engineer for this issue.
        /// </field>
    ...
    function IssueStatusChange(entitySet) {
        ...
        /// </field>
        /// <field name="CreatedBy" type="String">
        /// Gets or sets the createdBy for this issueStatusChange.
        /// </field>
        /// <field name="Created" type="Date">
        /// Gets or sets the created for this issueStatusChange.
        /// </field>
        /// <field name="ModifiedBy" type="String">
        /// Gets or sets the modifiedBy for this issueStatusChange.
        /// </field>
        /// <field name="Modified" type="Date">
        /// Gets or sets the modified for this issueStatusChange.
        /// </field>
        /// <field name="RowVersion" type="Array">
    ...
    function IssueStatus(entitySet) {
        ...
        /// </field>
        /// <field name="Issue" type="msls.EntityCollection" elementType="msls.application.Issue">
        /// Gets the issue for this issueStatus.
        /// </field>
        /// <field name="ChangeHistory_NewStatus" type="msls.EntityCollection" elementType="msls.application.IssueStatusChange">
        /// Gets the changeHistory_NewStatus for this issueStatus.
        /// </field>
        /// <field name="ChangeHistory_OldStatus" type="msls.EntityCollection" elementType="msls.application.IssueStatusChange">
        /// Gets the changeHistory_OldStatus for this issueStatus.
        /// </field>
        /// <field name="Issues" type="msls.EntityCollection" elementType="msls.application.Issue">
    ...
    function AuditDetail(entitySet) {
        /// <summary>
        /// Represents the AuditDetail entity type.
        /// </summary>
        /// <param name="entitySet" type="msls.EntitySet" optional="true">
        /// The entity set that should contain this auditDetail.
        /// </param>
        /// <field name="AuditID" type="Number">
        /// Gets or sets the auditID for this auditDetail.
        /// </field>
        /// <field name="AuditDesc" type="String">
        /// Gets or sets the auditDesc for this auditDetail.
        /// </field>
        /// <field name="LoginName" type="String">
        /// Gets or sets the loginName for this auditDetail.
        /// </field>
        /// <field name="AuditDate" type="Date">
        /// Gets or sets the auditDate for this auditDetail.
        /// </field>
        /// <field name="details" type="msls.application.AuditDetail.Details">
        /// Gets the details for this auditDetail.
        /// </field>
        $Entity.call(this, entitySet);
    }
    ...
    function AuditDataSource(dataWorkspace) {
        /// <summary>
        /// Represents the AuditDataSource data service.
        /// </summary>
        /// <param name="dataWorkspace" type="msls.DataWorkspace">
        /// The data workspace that created this data service.
        /// </param>
        /// <field name="AuditDetails" type="msls.EntitySet">
        /// Gets the AuditDetails entity set.
        /// </field>
        /// <field name="details" type="msls.application.AuditDataSource.Details">
        /// Gets the details for this data service.
        /// </field>
        $DataService.call(this, dataWorkspace);
    };
    function DataWorkspace() {
        ...
        /// </field>
        /// <field name="AuditDataSource" type="msls.application.AuditDataSource">
        /// Gets the AuditDataSource data service.
        /// </field>
    ...
    msls._addToNamespace("msls.application", {
        ...
        Engineer: $defineEntity(Engineer, [
            ...
            { name: "ClosedIssues", kind: "collection", elementType: Issue },
            { name: "CreatedBy", type: String, isReadOnly: true },
            { name: "Created", type: Date, isReadOnly: true },
            { name: "ModifiedBy", type: String, isReadOnly: true },
            { name: "Modified", type: Date, isReadOnly: true },
        ...
        Issue: $defineEntity(Issue, [
            ...
            { name: "IssueStatusCollection", kind: "reference", type: IssueStatus },
        ...
        IssueStatus: $defineEntity(IssueStatus, [
            ...
            { name: "Issue", kind: "collection", elementType: Issue },
            { name: "ChangeHistory_NewStatus", kind: "collection", elementType: IssueStatusChange },
            { name: "ChangeHistory_OldStatus", kind: "collection", elementType: IssueStatusChange },
            { name: "Issues", kind: "collection", elementType: Issue },
            { name: "CreatedBy", type: String, isReadOnly: true },
            { name: "Created", type: Date, isReadOnly: true },
            { name: "ModifiedBy", type: String, isReadOnly: true },
        ...
        AuditDetail: $defineEntity(AuditDetail, [
            { name: "AuditID", type: Number, isReadOnly: true },
            { name: "AuditDesc", type: String },
            { name: "LoginName", type: String },
        ...
        ApplicationData: $defineDataService(ApplicationData, lightSwitchApplication.rootUri + "/ApplicationData.svc", [
            ...
            {
                name: "IssuesForLastYear", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.Issues },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/IssuesForLastYear()",
                        {
                        });
                }
            },
            ...
            {
                name: "IssueStatusClosed", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.IssueStatusSet },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/IssueStatusClosed",
                        {
                        });
                }
            },
        ...
        AuditDataSource: $defineDataService(AuditDataSource, lightSwitchApplication.rootUri + "/AuditDataSource.svc", [
            { name: "AuditDetails", elementType: AuditDetail }
        ], [
            {
                name: "AuditDetails_SingleOrDefault", value: function (AuditID) {
                    return new $DataServiceQuery({ _entitySet: this.AuditDetails },
                        lightSwitchApplication.rootUri + "/AuditDataSource.svc" + "/AuditDetails(" + "AuditID=" + $toODataString(AuditID, "Int32?") + ")"
                    );
                }
            }
        ]),
        ...
        DataWorkspace: $defineDataWorkspace(DataWorkspace, [
            ...
            { name: "AuditDataSource", type: AuditDataSource }
        ])

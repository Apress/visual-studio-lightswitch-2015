...
Namespace Resources
    ...
    <ResourceProvider("ApressExtensionVB.HighlightButton")>
    Friend Class HighlightButtonImageProvider
...
#Region "IResourceProvider Members"
        ...
        Public Function GetResource(ByVal resourceId As String, ByVal cultureInfo As CultureInfo) As Object Implements IResourceProvider.GetResource
            Return New BitmapImage(New Uri("/ApressExtensionVB.Client.Design;component/Resources/ControlImages/HighlightButton.png", UriKind.Relative))
        End Function

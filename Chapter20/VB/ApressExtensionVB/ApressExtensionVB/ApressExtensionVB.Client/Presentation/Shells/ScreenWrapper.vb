...
'Listing 20-14. ScreenWrapper Object 
...
Namespace Presentation.Shells
    ...
    Public Class ScreenWrapper
        ...
        Friend Sub New(screenObject As IScreenObject)
            ...
            Dim dataServices As IEnumerable(Of IDataService) = screenObject.Details.DataWorkspace.Details.Properties.All().OfType(
            ...
            For Each dataService As IDataService In dataServices
                Me.dataServicePropertyChangedListeners.Add(
                  CType(dataService.Details, 
            INotifyPropertyChanged).CreateWeakPropertyChangedListener(

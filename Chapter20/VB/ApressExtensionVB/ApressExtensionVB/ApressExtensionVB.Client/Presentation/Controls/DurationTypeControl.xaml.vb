...
Namespace Presentation.Controls
    ...
    Partial Public Class DurationTypeControl
    ...
    <ControlFactory("ApressExtensionVB:DurationTypeControl")>
    Friend Class DurationTypeControlFactory
        ...
        Public ReadOnly Property DataTemplate As DataTemplate Implements IControlFactory.DataTemplate
            Get
                If Me.cachedDataTemplate Is Nothing Then
                    Me.cachedDataTemplate = TryCast(XamlReader.Load(DurationTypeControlFactory.ControlTemplate), DataTemplate)
                End If

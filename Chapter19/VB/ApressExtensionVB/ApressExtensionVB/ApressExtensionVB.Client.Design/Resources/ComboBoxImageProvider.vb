...
Namespace Resources
    ...
    <ResourceProvider("ApressExtensionVB.ComboBox")>
    Friend Class ComboBoxImageProvider
...
#Region "IResourceProvider Members"
        ...
        Public Function GetResource(ByVal resourceId As String, ByVal cultureInfo As CultureInfo) As Object Implements IResourceProvider.GetResource
            Return New BitmapImage(New Uri("/ApressExtensionVB.Client.Design;component/Resources/ControlImages/ComboBox.png", UriKind.Relative))
        End Function
